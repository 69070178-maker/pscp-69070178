...
```text
โจทยให้สร้างสะพานโดยที่มีอิฐอันใหญ่และอันเล็กซึ่งต้องใช้อันใหญ่ก่อนแล้วค่อยใช้อันเล็กเพราะต้องการหาว่าใช้อันเล็กน้อยสุดกี่อันในการสร้างสะพาน

input:
a อิฐอันเล็ก 1 นิ้ว
b อิฐอันใหญ๋ 5 นิ้ว
goal ความยาวของสะพานที่ต้องการสร้าง

output:
อิฐอันเล็กจำนวนน้อยที่สุดที่ใช้ในการสร้างสะพาน
ถ้าสร้างไม่ได้ตอบ -1

constraints:
ต้องระวังเรื่องเงื่อนไขการสร้างดีๆ ว่าสร้างได้มั้ยแ่ล้วจำนวนเท่ากับอิฐที่มีรึป่าว
...
```text
แผนแรกคือทำโดยใช้ for loop โดยให้ลูปไปสอง  for loop ลูปแรกคือลูปลดระยะทางของ goal  โดยใช้อิฐอันใหญ่ต่อแล้วพอจบลุปแรกก็ไปต่อลูปสองคือนำระยะทางที่เหลือจากลูปแรกมาลูปลดระยะทางต่อโดยใข้อิฐก้อนเล็กสร้างแต่ลูปนี้มีบวก นับจำนวนอันเล็กที่ใช้ไปด้วย อันนี้จะอยู่ในเงื่อนไขถ้าระยะทางที่สร้างได้มากกว่าหรือเท่ากับระยะทางที่ต้องการแล้วก็มีอีเงื่อนไขนึงถ้าไม่เข้าเงื่อนไขแรกก็คือถ้าระยะที่สร้างได้น้อยกว่าระยะทางที่ต้องกานต้องพิมพ์์ -1
```
...
```text
วิธีสุดท้่ายใช้เป็นการคิดสูตรแทนลูปโดยใช้ฟังชั่น min() ร่วมด้วย เราต้องการหาว่าอิฐใหญ่ใช้เท่าไหร่และอิฐเล็กใช้เท่าไหร่แต่ถ้าหาโดยวิธีการหารระยะทางทั้งหมดก็อาจจะมีกรณีเกินอิฐที่มีอยู่เลยต้องใช้ฟังชั่น min( )ในการเลือกว่าระหว่าง จำนวนที่มีอยู่, จำนวนที่หาจากระยะทาง ส่วนของอิฐเล็กก็คล้ายๆ กันแล้วคิดระยะทางที่สร้างได้ทั้งหมดจากอิฐที่ใช้ได้จากนั้นก็เข้าเงื่อนไขเหมือนเดิม
```
...
```text
เพราะต้องการเช็กกรณีที่ถึงแม้ว่้าอิฐทั้งสองจะรวมกันแล้วระยะทางเกินจากที่กำหนดไว้แต่ก็สร้างไม่ได้อยู่ดีเพราะมันจะเกินระยะทางที่กำหนด
...
```text
ทดสอบกรณีที่ระยะทางที่ต้องสร้างเยอะเกินจำนวนอิฐ
```
