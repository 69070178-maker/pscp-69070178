...
```text
โจทย์ให้สลับตัวอักษรโดยเปลี่ยนตัวอักษรจากหน้าไปหลังแล้ว output ทุกตัวต้องเป็นตัวพิมพ์เล็ก

input:
ให้รับค่าข้อความมาเป็น str แล้วใช้ .lower เพื่อเปลี่ยนทุกตัวอักษรเป็นตัวพิมพ์เล็ก 

output:
โปรแกรมจะแสดงข้อความที่เรียงใหม่จากหลังไปหน้าแทน

Constraints:
ต้องอย่าลืมว่าต้อง output ออกมาเป็นตัวพิมพ์เล็กหมด
```
...
```text
Step 1: รับ input ข้อความ
Step 2: ปริ้นข้อความกลับหลัง โดยใช้ index

ก่อนถามเพื่อนฉันรู้ว่าต้องใช้ index แต่ว่ากลับลืมว่าต้องพิมพ์ยังไงจึงหันไปถามเพื่อน
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรกก็คือรับ input ข้อความมาก่อนแแล้วก็แสดงข้อความกลับหลังออกมาโดยใช้ การเข้่าถึง index โดยใช้ให้ ถอยหลังทีละก้าว -1 จะได้เริ่มแสดงข้อความจะหลังมาหน้า 
```
...
```text
เพราะอยากทดสอบว่าโปรแกรมใช้ได้จริงมั้ย
```
...
```text
เพราะอยากลองว่าถ้าเราใส่ตัวพิมพ์ใหญ่เข้าไปด้วยมันจะปรับเป็นตัวเล็กให้มั้ย
```
...
```text
ลองให้เป็นตัวพิมพ์ใหญ๋สลับกับเล็กดูว่าเปลี่ยนเป็ตัวพิมพ์เล็กได้หมดจริงหรือไม่
```
...
```text
เรื่องการเขียนตัวอักษรกลับหลังว่ามี sytax ยังไง
```

คุณยังทำอะไรด้วยตนเอง

```text
คิดขั้นตอนรับอินพุตแล้วการแปลงตัวอักษรจากหลังมาหน้า
```
