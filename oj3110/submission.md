...
```text
โจทย์ให้คิดราคาของค่สั่งที่ให้มาในตารางโดยให้ต้นทางปลายทางมาและน้ำหนักพัสดุแล้วคิดตามตารางที่ให้มา
...
output:
แสดงราคาการส่งพัสดุ
ถ้ามีเส้นทางที่ไม่ได้ระบุให้แสดง Error

constraints:
output ต้องออกมาเป็นทศนิยมสองตำแหน่ง
input น้้ำหนักต้องเป็ฯ float
```
...
```text
แผนแรกใช้ if-else ในการทำ โดยให้ ต้นทาง start เป็นตัวเช็คก่อนในทุกอันแล้วเงื่อนไขใน start ก็คือเช็ค stop อีกว่าไปจบที่ไหน จากน้นก็ คำนวนและแสดงราคาออกมา
```
...
```text
วิธีสุดท้ายคล้ายกับวิธีแรกก็คือ ให้เช็ค start ก่อนแล้วในเงื่อนไข start ก็เป็นเช็คสาขาปลายทางอีกกรอบจากนั้นก็คำนวนน้ำหนัก ถ้าไม่เข้าเงื่อนไขลยก็ error 
```
...
```text
เพื่อทดสอบการทำงานพื้นฐานแบบปกติ
```
...
```text
เพื่อทดสอบค่าต่ำสุดเพราะถ้าเป็นแบบนี้ต้องคิดแค่ค่าธรรมเนียมเป็น 40 บาท
```
...
```text
เพื่อทดสอบเงื่อนไข error ว่าเข้าเงื่อนไขตามโจทย์หรือไม่
```
