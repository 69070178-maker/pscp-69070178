...
```text
ฉันถามเรื่อง test case ให้ช่วยคิดว่าฉันลืมเขียนเงื่อนไขอะไรไป เพราะเมื่อไปส่งแล้วมีบางอันไม่ผ่าน
```
...
```text
ช่วยให้สังเกตเรื่องเงื่อนไขที่เราคาดไม่ถึง จริงๆ มันมีกรณีอีกอันด้วยก็คือการผสมสีเดียวกัน
```
...
```text
ฉันเพิ่มเงื่อนไขตรวจสอบสีผสมที่เหมือนกันไปแล้วทดสอบในโปรแกรม vscode 
```
...
```text
ฉันได้เรียนรู้ว่าเราควรคิดอะไรให้รอบครอบโดยเฉพาะเรื่องเงื่อนไขถ้ามันไม่ครอบคลุมมันจะทำให้โปรแกรมเราผิดพลาดได้
```
