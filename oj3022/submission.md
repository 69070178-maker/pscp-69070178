...
```text
โจทย์ให้เปลี่ยนอุณหภูมิจากอุณหภูมิหนึ่งเป็นอีกอุณหภูมิหนึ่งโดยมีหน่วย ฟาเรนไฮต์ (F), เคลวิน (K), และแรงคิน (R) จากหน่วยเซลเซียส (C) 

input:
รับค่าเป็นจำนวนจริงค่าอุณภูมิ
รับค่า C K F R แทนหน่วยอุณหภูมิในบรรทัดที่ 1
เป็นอักษร C K F R เป็นหน่วยอุณหภูมิที่อยากเปลี่นยน

output:
จำนวนจริงเป็นอุณหภูมิตามหน่วยที่เราต้องการเปลี่ยน ่ตอบทศนิยมสองตำแหน่ง

constraints:
ต้องระวังประเภทค่าที่รับเข้ามาแล้วส่งออกไป 
บรรทัดแรกต้องรับค่าเป็นจำนวนเต็ม
แล้ว output ออกมาต้องเป็นทศนิยมสองตำแหน่ง
```
...
```text
Step 1: รับค่าอุณหภูมิ หน่วยของอุณหภูมิและหน่วยที่ต้องการเปลี่ยน
Step 2: ตรวจว่ากับเงื่อนไขว่า อุณหภูมิเป็นหน่วยไหน
Step 3: เมื่อตรวจแล้วเข้าเงื่อนไขให้เอาอุณหภูมิเข้าสูตรแล้วไปเปลี่ยนเป็นองศาเซลเซียส
Step 4: จากนั้นเช็คอีกทีว่าหน่วยที่ต้องการเปลี่ยนเป้นหน่วยไหน 
step 5: พอเข้าเงื่อนไขการเปลี่ยนอุณหภูมิโดยเปลี่ยนจากหน่วย C เป็นหน่วยที่ต้องการและแสดงผลออกมา
ก่อนคุยกับเพื่อนรู้แล้วต้องทำยังไง เพื่อนช่วยเขียนออกมาเป็นโค้ด
```
...
```text
เหมือนแผนแรกก็คือ ตั้งตัวแปร celsius  ขึ้น มาให้เท่ากับอุณหภูมิที่ต้องการแปลงและตั้ง if เป็นสอง if ใหญ่ if แรกตรวจสอบว่าอุณหภูมิที่ได้ได้หน่วยอะไรมาแล้วเอาไปแปลงเป็น celsius จากนั้น ตั้งตัวแปร result ขึ้นมา เท่้ากับ celsius จากนั้นเอาไปตรวจใน if ใหญ๋ที่สองว่า หน่วยที่ต้องการแปลงคือหน่วยอะไรแล้วเอาไปแปลงเข้าสูตรจากนั้นก็แสดงผลอุณหภมิที่ได้ออกมา
```
...
```text
ทดสอบการแปลงข้ามหน่วยแบบไม่ผ่าน Celsius 
```
...
```text
เขาช่วยให้กระบวนการคิดออกมาเป็นโค้ด
```

คุณยังทำอะไรด้วยตนเอง

```text
คิดเรื่องแผนการแก้ problem นี้ว่าต้องทำอะไรก่อน แล้วก็ช่วยแปลงสมการเรื่องแปลงเป็นเซลเซียส
```
