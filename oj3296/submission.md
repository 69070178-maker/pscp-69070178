...
```text
โจทย์.ให้เลข r g b มาสองชุดให้หาค่าเฉลี่ยระหว่าง 2 ชุดนั้น

Input:
2[ บรรทัด
 ตัวเลข 3 ตัว คั่นด้วยช่องว่าง แทนค่า R, G, B ของสีที่ 1
 ตัวเลข 3 ตัว คั่นด้วยช่องว่าง แทนค่า R, G, B ของสีที่ 2

Output:
ตัวเลขผลลัพธ์การผสมสี R, G, B จำนวน 3 ตัว คั่นด้วยช่องว่าง
...
```text
Step 1: รับค่า ชุดสี่ 1,2 โดยใช้ map(int,input().split())
Step 2: จากนั้นหาค่าเฉลี่ยทีละตัว ใช้ สูตร r3 = (r1 + r2) // 2 ไปทุกสี
Step 3: print สามสีที่หาค่าเฉลี่ยมา
```
...
```text
ทดสอบการใช้ค่าขอบเขตต่ำสุดและสูงสุด
```
...
```text
ทดสอบกรณีที่นำสีเดียวกัน 2 สีมาผสมกัน ค่าเฉลี่ยที่ได้จะต้องเท่ากับค่าเดิม
```
