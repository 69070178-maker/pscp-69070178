...
```text
ได้รับจำนวนเต็มมาว่าทำกี่ครั้งแล้วจากนั้นก็เขียนว่าทำอะไรบ้าง มีการกระทำ บวกและลบ บวก 10 ลบ 5 ทำไปเรื่อยๆ
และแสดงผลรวมทั้งหมดมา
...
Step 2: for-loop ตามจำนวน n
Step 3: รับค่า game
Step 4: เช็กเงื่อนไขถ้า game == "+"  ให้ score += 10
Step 5: ถ้าไม่ก็ไปเช็กถ้า เงื่อนไข game == "-" score -= 5
Step 6: จากนั้นแสดงผล score
```
...
```text
วิธีสุดท้ายเหมือนแผนแรกคือรับ n มา สร้างตัวแปร score = 0 for loop รับค่า + - แล้วเช็กเงื่อนไขแล้ว บวกลบ ค่าใน score
```
...
```text
ทดสอบ Edge Case กรณีที่ผู้เล่นโดนหักคะแนนติดต่อ
```
