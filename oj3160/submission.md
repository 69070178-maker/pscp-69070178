...
```text
โจทย์ให้หาจำนวนเฉพาะ

Input:
รับบรรทัดเดียวเป็นเลขเริ่มและสิ้นสุด
...
Constraints:
เลข 1 กับ 0 ไม่ใช่จำนวนเฉพาะ ติดลบไม่ใข่จำนวนเฉพาะ
```
...
2. สร้าง list
3. เข้า loop
4. ถ้า i อยู่ใน 2 3 5 7 ก็เพิ่มไปใน list
5. เช็คว่าหาร 2 3 5 7 ลงตัวมั้ย ถ้าลงก็ไม่ต้องทำอะไร
6.  เช็คว่าถ้าเป็น 1แลั 0 ก็ไม่ต้องทำอะไร
7. else ก็เป็น  เพิ่ม i ไปใน list
8. print list และปริ้น len(list)
```
...
```text
วิธีสุดท้ายเหมือนกับวิธีแรกแค่ต้องมีการเพิ่มว่า ถ้ามีอะไรอยู่ในlist ก็ปริ้น จำนวนเฉพาะมา แต่ถ้าไม่มีก็ไม่ต้องทำอะไร
```
