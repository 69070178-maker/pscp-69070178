...
```text
ป้อนตัวย่อของชื่อเต็มไพ่แล้วเราต้องเขียนโปรแกรมแปลงตัวอักษรย่อเป็นชื่อเต็ม โดยมี of อยู่ตรงกลาง  QS ก็คือ queen of spades , 10C ก็คือ 10 of clubs

input:
รับเป็นข้อความ 1 ข้อความ

output:
แสดงผลชื่อไพ่

constraints:
input ต้อบงรับโดยจะเป็นตัวอักษร 1 ตัว คือ A หรือ J หรือ Q หรือ K หรือ จำนวนเต็ม 1 จำนวนตั้งแต่ 2 - 10 แล้วตามด้วยตัวอักษร 1 ตัว คือ D หรือ H หรือ S หรือ C โดยตัวอักษรภาษาอังกฤษนั้นสามารถรับได้ทั้งพิมพ์ใหญ่พิมพ์เล็ก
```
...
```text
1. สร้าง dict เก็บค่าชื่อและตัวย่อไว้ 
2. ใช้ for loop กับ input text ที่รับมา
แต่ว่าพอลองทำแล้วคิดต่อไม่ออกว่าจะใส่for หรือเก็บตัวที่เป็นเลขไว้ยังไงเลยเปลี่ยนแผน
```
...
```text
รับ ค่า text มา และสร้างตัวแปร num ให้เป็น str ว่างและ char ให้เป็น list ว่างให้ทุกตัวเป็นตัวพิมพ์เล็ก ใช้ for i in text ให้ลูปในข้อความถ้าเป้นตัวเลขให้บวกใส่ใน num  แต่ถ้าไม่เป็นให้ append i เข้าไปใน char จากนั้นก็สร้าง list de_char เป็น list ว่าง แล้วก็ loop ใน char ถ้า i ตรงกับตัวย่อให้ให้ append ใส่เข้าไปใน de_char จากนั้นก็สู่การแสดงผล ถ้า num เป็น true ให้ปริ้น print(num,"of",*de_char) ถ้าไม่ให้ปริ้น โดยใช้ join of ใน de_char
```
...
```text
 เพราะต้องการทดสอบกรณีที่เป็นตัวพิมพ์เล็ก
```
...
```text
เพราะต้องการทดสอบถ้ามีตัวพิมพ์เล็กปนกับตัวเลข
```
...
```text
ต้องการทดสอบกรณีเป็นตัวพิมพ์ใหญ่
```
...
```text
เรื่องการเริ่มคิดโจทย์ว่าไม่ใช่ dict ก็ได้
```

คุณยังทำอะไรด้วยตนเอง

```text
มาเขียนต่อโดยเลือกใช้ list กับ if-else
```
