...
```text
รับข้อความเข้ามาแล้วเช็กข้อความว่ามีสระ a e i o u ในนั้นมั้ยถ้ามีก็บอกว่ามีตัวไหนกี่ตัว

input:
text รับข้อความเข้ามา

output:
แสดงจำนวนและตัวสระที่เจอ

constraints:
ต้องระวังตอนตรวจสอบต้องตรวจสอบตั้งตัวอักษรพิมพ์เล็กและพิมพ์ใหญ่
```
...
```text
Step 1: ตั้งรับ input ตัวแปร text ให้้รับมาแล้วใช้ .lower ให้เป็นตัวพิมพ์เล็กให้หมด
Step 2: ตั้งตัวแปรนับค่า a e i o u แยกมาให้ครบทุกสระ
Step 3: ใช้ลูป i ลูปไปใน text 
Step 4: ในลูปมีเงื่อนไขถ้า i = ตัวสระไหนให้บวกตัวนับสระนั้นเพิ่มในตัวแปรของสระนั้นๆ +1
Step 5:ถ้าไม่มีก็ไม่ต้องบวกเพิ่ม
Step 6: เมื่อจบลูปตั้งเงื่อนไขเช็กว่าสระไหนมีถ้ามีก็ปริ้นสระนั้นๆ ใช้ if และ elif
```
...
```text
วิธีสุดท้ายคล้ายกับแผนแรกแต่เปลี่ยนจากตอนสุดท้ายที่ใช้ if และ elif ในการเช็กว่าอันไหนมีสระไหน เปลี่ยนเป็นใช้เ if ทั้งหมดเพราะถ้าเข้าเช็กที่ละอันมันจะไม่เช็คทุกตัวและปริ้นออกมา
```
...
```text
ทดสอบถ้าเป็นตัวพิมพ์ใหญ่จะตรวจสอบหรือไม่
```
...
```text
ทดสอบถ้าทุกตัวสุ่มสลับใหญ่เล็กจะทำงานตรวจสอบได้ปกติมั้ย
```
