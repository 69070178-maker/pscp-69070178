...
```text
โจทย์ต้องการจำนวนที่กระโดดน้อยที่สุด โดยครั้งแรกที่กระโดดจะได้ระยะ x เมตร และจะลดระยะกระโดดทีละสองในครั้งต่อๆ ไป จนกว่าจะ ถึงระยะ y เมตรหรือมากกว่า ถ้าไม่ถึง พิมพ์ -1

input:
จำนวนเต็ม x และ y

output:
จำนวนครั้งกระโดดขั้นต่ำ
...
```text
1. รับตัวแปร x y มา 
2. สร้างตัวแปร count และ distance 
3. ใช้ while loop ในการลุปหาจำนวนกระโดด
4. จากนั้นก็ใช้ if-else แสดงผลข้อมูลถ้าระยะไม่ถึงปริ้น -1 ถ้าถึงปริ้น count
...
```text
วิธีสุดท้ายคล้ายกับวิธีแรกคือ ใช้ while ลูป โดย ใช้เงื่อนไขลูปคือ distance < y ในลุปจะมีเงื่อไขถ้า  x > 0 ให้ระยะบวก x  แล้วก็ เอาสองไปลบ x ต่อ จากนั้นนอกลูปก็ += 1 count ถ้าไม่เข้าเงื่อนไขก็หยุดลุป  จากนั้นก็เงื่อนไขปริ้นเหมือนที่คิดตอนแรก
