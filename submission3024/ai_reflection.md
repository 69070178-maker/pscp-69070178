...
```text
ให้ ai ช่วยคิดว่าทำไมไม่ผ่าน เทสเคสนึงเรามีจุดโหว่อะไรในโค้ดเรารึป่าว 
```
...
```text
ให้เห็นว่าโค้ดเรามีช่องโหว่อยู่ในกรณีที่ left มีมากว่า hightest และ กรณีที่ lowest เป้น 0
```
...
```text
ฉันเขียนเงื่อนไขเพิ่มในกรณีที่ lowest ได้ค่าต่ำกว่า 0 ให้เปลียน lowest มีค่าเท่ากับ 0 แล้วก็เปลี่ยน จากที่คิดให้ mid  = hightest  ให้เป็น mid = min(hightest,left ) เพื่อป้องกันกรณีที่ left มีน้อยกว่า hightest
```
...
```text
ฉันได้เรียนรู้วิธีการคิดใช้ min แล้วก็การคิดเงื่อนไข eage case ให้รอบครอบ
```
