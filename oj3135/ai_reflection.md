...
| Item | Answer |
|---|---|
| OJ problem number/title | OJ3135 - [LEARNING LOGS] ของขวัญและขโมย |
| OJ submission ID, if submitted | 	640423 |
| OJ status | Pass |
...
```text
ฉันถาม AI ให้ช่วยชี้แนะแนวทางในการคิดวิเคราะห์โจทย์ออกมาเป็นโลจิกโค้ด และได้ให้คิด edge case ให้
```
...
```text
AI ช่วยให้ฉันเห็น condition ที่ฉันคิดไม่รอบคอบทำให้สามารถแก้ไขปัญหาเรื่อง edge case ได้ และช่วยให้ฉันฝึกคิดวิเคราะห์ชี้แนวทางการแก้ไขปัญหาได้ด้วยตนเอง
```
...
```text
หลังจากฉันขอความช่วยเหลือเรื่องคิดโลจิกโค้ดของโจทย์ฉันก็ลงมือเขียนโค้ดด้วยตนเอง และได้แก้เรื่องเทสเคสเอง
```
...
```text
ฉันเรียนรู้ว่าเราควรคิดเทสเคสให้รอบคอบก่อนที่จะส่ง และการคิดโลจิกโค้ด
```
